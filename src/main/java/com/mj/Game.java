...
import static com.tools.WebSocketUtils.LIVING_SESSIONS_CACHE;
import static com.tools.WebSocketUtils.sendMessage;
import static com.tools.WebSocketUtils.sendMessageAll;

@RestController
@ServerEndpoint("/mj/{uuid}")
public class Game {
    ...
    @GetMapping("/mj/{sender}/to/{receive}")
